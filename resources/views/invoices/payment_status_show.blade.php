...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('payment_status_update', ['id' => $invoices->id]) }}" method="post"
                        autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="hidden" name="old_invoice_number" value="{{ $invoices->invoice_number }}">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" name="invoice_Date" placeholder="YYYY-MM-DD" type="text"
                                    value={{ $invoices->invoice_Date }} required readonly>
                            </div>

                            <div class="col">
                                <label>تاريخ الاستحقاق</label>
                                <input class="form-control" name="Due_date" placeholder="YYYY-MM-DD" type="text"
                                    value={{ $invoices->Due_date }} readonly>
                            </div>
