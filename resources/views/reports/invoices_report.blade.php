...
@if (session()->has('session_error'))
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>{{ session()->get('session_error') }}</strong>
...
@if (session()->has('invoice_type'))
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>{{ session()->get('invoice_type') }}</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
...
@if (session()->has('invoice_number'))
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>{{ session()->get('invoice_number') }}</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
        ...
        <div class="card mg-b-20">
                ...
                <form action="/invoices_search" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-sm-1 col-md-1">
                            <button class="btn btn-primary btn-block" type="submit" id="SearchButton">بحث</button>
                        </div>
                    </div>
                </form>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <br>
                    @if (isset($details))
                        <a href="{{ url('invoices_report_excel') }}" class="btn btn-info" style="color:white"><i
                                class="fas fa-plus"></i>&nbsp;تصدير الفاتورة أكسيل</a>
                        <br>
                        <br>
